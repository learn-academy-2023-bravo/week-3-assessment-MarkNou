...
// Create a function called arraySum
// Use a parameter called array as a placeholder
// Create a variable called 'sum' that equals 0, just to hold a empty value 
// iterate through the array, and use 'value' as a parameter
// Each iteration will equal the sum plus the value, and return the sum for every index into an array.
...
console.log(arraySum(accountTransactions1)); //output: [100, 83, 60, 51]
console.log(arraySum(accountTransactions2)); //output: [250, 161, 261, 165]
console.log(arraySum(accountTransactions3)); //output: []
